...
void MIDIStream::XG_initialize()
{
    ...
    for (auto& it : midi.get_channels())
    {
        ...
        INFO("Switching to XG Hall1 Reveberation");
            ...
            case XGMIDI_EFFECT1:
                ...
                case XGMIDI_CHORUS_TYPE:
                {
                    ...
                    case XGMIDI_PHASER1:
                        ...
                        INFO("Switching to XG Phaser1");
                        rv = true;
                        break;
                    case XGMIDI_PHASER2:
                        expl = "PHASER2";
                        midi.set_chorus("XG/phaser2");
                        INFO("Switching to XG Phaser2");
                        rv = true;
                        break;
                    default:
